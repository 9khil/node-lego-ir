...
LegoIR.prototype._buildNibbles = function(moveBinary){
  var that = this;
	...
	var modeName = this.config.opts.mode;
	var nibbles;
	...
	switch(modeName){
		...
		case('comboPWM'):
			nibbles = {
				nib1: '01'+this.config.channels[channel],
				nib2: '0010', //hardcoded forward 2, output b
				nib3: '0010' //hardcoded forward 2, output a
			};
			break;
	}
...
LegoIR.prototype.move = function(move){
	...
	//TODO: Need to build different kind of nibbles. see doc
